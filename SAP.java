...
public class SAP {
     ...
     * @param marked    represents the state of the vertex
     * @param length    distance from the original vertex
     * @param curLength current length
     */
...
//            System.out.println("bfs1 " + cur + " " + length[cur]);
     ...
     *
     * @param w         vertex w
     * @param marked1   represents the vertexes bfs1 marked
     * @param length    represents the corresponding distance bfs1 marked
     * @param marked2   represents the vertexes bfs2 marked
     * @param curLength current distance from original vertex
